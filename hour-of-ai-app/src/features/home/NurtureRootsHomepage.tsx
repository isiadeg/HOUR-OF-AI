      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-[#e6f4ed] shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button onClick={() => navigate('/signup/volunteer')} className="text-sm font-semibold text-[#0B6B3A] hover:underline">
              Volunteer
            </button>
            <GreenButton variant="filled" onClick={() => navigate('/signup/parent')}>Register as Student</GreenButton>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 max-w-xl">
              ...
              <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={5} className="flex flex-wrap gap-3">
                <GreenButton variant="filled" onClick={() => navigate('/signup/parent')}>
                  <BookOpen size={15} />
                  Register as Student
                </GreenButton>
                <GreenButton variant="outline" onClick={() => navigate('/signup/volunteer')}>
                  <Heart size={15} />
                  Register as Volunteer
                </GreenButton>
                <GreenButton variant="ghost" onClick={() => navigate('/signup/hub')}>
                  <Building2 size={15} />
          ...
          <motion.div variants={fadeUp} custom={0} className="relative bg-gradient-to-br from-[#0B6B3A] via-[#0d7c44] to-[#22a860] rounded-3xl px-8 py-14 lg:py-20 text-center overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <button onClick={() => navigate('/signup/parent')} className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-white text-[#0B6B3A] font-bold text-sm hover:bg-green-50 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200">
                  <BookOpen size={16} /> Start Learning
                </button>
                <button onClick={() => navigate('/signup/volunteer')} className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-white/10 text-white border border-white/30 font-bold text-sm hover:bg-white/20 hover:-translate-y-0.5 transition-all duration-200">
