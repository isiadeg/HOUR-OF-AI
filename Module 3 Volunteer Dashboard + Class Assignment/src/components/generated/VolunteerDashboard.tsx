...
const TopBar = ({
  ...
  return <header className="h-16 bg-white border-b border-[#e6f4ed] flex items-center px-4 sm:px-6 gap-4 shrink-0 z-30">
      ...
      <div className="flex items-center gap-3 ml-auto">
        ...
        {/* Update Availability */}
        <button className="hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#0B6B3A] text-white text-xs font-bold hover:bg-[#095e32] transition-colors shadow-sm">
...
export const VolunteerDashboard = () => {
  ...
  return <div className="w-full h-screen flex overflow-hidden bg-[#f5fbf7] font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        <TopBar activePage={activePage} onMenuToggle={() => {
        setSidebarOpen(v => !v);
