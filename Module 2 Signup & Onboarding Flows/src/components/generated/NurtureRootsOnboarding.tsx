        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
          ...
          <div className="px-6 py-6">
            ...
            <div className="mt-6 space-y-3">
              <button className="w-full py-3.5 rounded-xl bg-[#0B6B3A] text-white font-bold text-sm hover:bg-[#095e32] shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2">
...
export const NurtureRootsOnboarding = ({
  ...
  const [screen, setScreen] = useState<AppScreen>('role_select');
  ...
  return <div className="w-full min-h-screen font-sans">
      <AnimatePresence mode="wait">
        ...
        {screen === 'confirmation' && selectedRole && <motion.div key="confirmation" initial={{
        opacity: 0,
        scale: 0.96
      }} animate={{
        opacity: 1,
        ...
        opacity: 0
            ...
            <ConfirmationScreen role={selectedRole} onGoHome={handleGoHome} />
          </motion.div>}
      </AnimatePresence>
    </div>;
};